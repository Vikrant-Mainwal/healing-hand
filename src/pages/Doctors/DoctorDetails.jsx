        ...
        <div className="md:col-span-2 ">
          <div className=" flex items-center gap-5">
            <figure className='max-w-[200px] max-h-[200px]'>
              ...
              <div>
            <span className=" bg-slate-300 text-irisBlueColor py-1 px-6 lg:py-2 lg:px-6 text-[12px] leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded">Surgeon</span>
            <h3 className='text-headingColor text-[22px] leading-9 mt-3 font-bold'>Vikrant</h3>
            ...
            <p className='text__para text-[14px] leading-5 md:text-[15px] lg:max-w-[390px] '>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste ipsa eligendi minus exercitationem laboriosam fugit.
            </p>
